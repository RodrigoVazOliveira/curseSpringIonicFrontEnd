...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama mesa e banho'),(4,'sEletrônico'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumari');
...
INSERT INTO `endereco` VALUES (1,'Jardim','38220834','Apto 303','Rua Flores','300',1,1),(2,'Centro','38772012','Sala 800','Avenida matos','105',2,1);
...
CREATE TABLE `pagamento_com_cartao` (
  `numero_de_parcela` int(11) DEFAULT NULL,
  `pedido_id` int(11) NOT NULL,
  PRIMARY KEY (`pedido_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pedido` VALUES (1,'2019-09-30 10:36:00',1,1),(2,'2019-09-30 10:36:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colchão',200),(7,'TV True Color',1200),(8,'Roçadeira',800),(9,'Pendente',180),(10,'Abajour',100),(11,'Shampoo',80);
...
-- Dump completed on 2019-09-25 17:15:20
